...
class test_basemodel(unittest.TestCase):
    ...
    """
    The class for testing pep8 on the base_model file"""
    def test_pycodestyle(self):
        """
        Testin for pep8 formatting
        """
        pycodestile = pycodestyle.StyleGuide(quiet=True)
        result = pycodestile.check_files(['models/base_model.py'])
